...
#BSP:modify lcm driver LCQHLYYLR-1 by shiyu.xu 20200310 start
BOOT_LOGO = hdplus1640
#BSP:modify lcm driver LCQHLYYLR-1 by shiyu.xu 20200310 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_PRELOADER = yes
CUSTOM_BUILD_VERNO =
#BSP: add annotation for ANDROIDRBE-299 by muduo.qin 20200527 start
CUSTOM_CONFIG_MAX_DRAM_SIZE = 0xC0000000
#BSP: add annotation for ANDROIDRBE-299 by muduo.qin 20200527 end
...
TRAN_CAM_FRONT_FLASHLIGHT_SUPPORT = yes
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw gc8034_mipi_raw
CUSTOM_TRAN_CAM_MATERIAL_CODE=s5k3l6_17201599 gc8034_17201572
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l6_mipi_raw
#BSP: add LCQHLYYLR-3 by zhigang.yang for 20200317 start
CUSTOM_HAL_MSENSORLIB =
#BSP: add LCQHLYYLR-3 by zhigang.yang for 20200317 end
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = gc8034_mipi_raw
...
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw gc8034_mipi_raw
#ITD:modify by camera driver team end
...
#ITD:modify by camera driver team start
CUSTOM_KERNEL_SUB_IMGSENSOR = gc8034_mipi_raw
#ITD:modify by camera driver team end
...
#TSD: modify LCQHLYYL-3 by xiaochen.ye 20191021 for checklist start
CUSTOM_MODEM = lc7_h6116_b1
#TSD: modify LCQHLYYL-3 by xiaochen.ye 20191021 for checklist end
...
#BSP:modify tee config LCQHLYYLR-38 by lichen 20200629 start
MICROTRUST_TEE_SUPPORT = yes
#BSP:modify tee config LCQHLYYLR-38 by lichen 20200629 end
MNTL_SUPPORT = no
MTK_2IN1_SPK_SUPPORT = no
MTK_AAL_SUPPORT = yes
#BSP: modify MTK patch default setting by muduo.qin 20200514 start
MTK_AB_OTA_UPDATER = no
#BSP: modify MTK patch default setting by muduo.qin 20200514 end
MTK_AEE_SUPPORT = yes
MTK_AGPS_APP = yes
MTK_AIV_SUPPORT = no
...
#BSP:modify audio bring up XLJLHLJYR-4 shuanglei.wang 20200313 start
MTK_AUDIO_NUMBER_OF_MIC = 1
MTK_AUDIO_NUMBER_OF_SPEAKER = 1
MTK_AUDIO_SPEAKER_PATH = int_hp_buf
#BSP:modify audio bring up XLJLHLJYR-4 shuanglei.wang 20200313 end
...
#BSP:add lc7 charger function BLSLEPUB-2076 by ming.chen  20191031 start
MTK_DUAL_CHARGER_SUPPORT = no
#BSP:add lc7 charger function BLSLEPUB-2076 by ming.chen  20191031 end
...
#TSD:add short fm LCQHLYYLR-23 by huijun.shen 20200602 start
MTK_FM_SHORT_ANTENNA_SUPPORT = yes
MTK_FM_SUPPORT = yes
MTK_FM_GPIO_FUNC = yes
#TSD:add short fm LCQHLYYLR-23 by huijun.shen 20200602 end
...
#TCD: modify for ctsdeqptest ANDROIDRBE-169 by mingwei.xue 20200415 start
MTK_MOBILE_MANAGEMENT = no
#TCD: modify for ctsdeqptest ANDROIDRBE-169 by mingwei.xue 20200415 end
...
#SDD: modify by jiangping.guo open signature 2020.03.24 start
MTK_SIGNATURE_CUSTOMIZATION = yes
#SDD: modify by jiangping.guo open signature 2020.03.24 end

MTK_SIM_HOT_SWAP = yes
#TSD: modify LCQHLYYL-3 by xiaochen.ye 20191018 for checklist start
MTK_SIM_HOT_SWAP_COMMON_SLOT = yes
MTK_FLIGHT_MODEM_POWER_OFF = no
#TSD: modify LCQHLYYL-3 by xiaochen.ye 20191018 for checklist end
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
#BSP: modify ANDROIDRBE-72 by qiang.wu2 20200408 start
MTK_UART_USB_SWITCH = yes
#BSP: modify ANDROIDRBE-72 by qiang.wu2 20200408 end
MTK_UCE_SUPPORT = no
MTK_UFS_OTP = no
...
#SDD: add lijia.chen XLJLHLJY-3169 20200312 start
...
MTK_BUILD_VERNO=LC7-H6116BCF-R-200703V218
TRAN_FINGERPRINT_BUILD_VERNO=BCF-200703V218
#BSP: add fingerprint bring up LCQHLYYL-12 by lingli.zhou 20191101 start
TRAN_FINGERPRINT_SUPPORT = sunwave_tee
#BSP: add fingerprint bring up LCQHLYYL-12 by lingli.zhou 20191101 end

#SDD: add lijia.chen XLJLHLJY-3169 20200312 end
