...
DEVICE_PATH := device/tecno/TECNO-LC7
...
# Assert
TARGET_OTA_ASSERT_DEVICE := TECNO-LC7
...
TARGET_KERNEL_SOURCE := kernel/tecno/TECNO-LC7
TARGET_KERNEL_CONFIG := TECNO-LC7_defconfig
